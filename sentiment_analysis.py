...
def get_model_tokenizer():
    ...
    tokenizer = Tokenizer(num_words=config.NUM)
    ...
    embedding_matrix = np.zeros((config.NUM, DIM))
    ...
    # Building the CNN
    tweet_input = Input(shape=(config.SENTENCE_LENGTH,), dtype='int32')
    tweet_encoder = Embedding(config.NUM, DIM, input_length=config.SENTENCE_LENGTH,
